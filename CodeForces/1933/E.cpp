...
int main()
{
	...
	while(t--)
	{
		...
		while(q--)
		{
			int l,u,r2,r1;
			cin>>l>>u;
			//find r,make sum[r]-sum[l-1]<=u
			//so, sum[r]-sum[l-1]<u
			//sum[r]<u+sum[l-1]
			r2=lower_bound(sum+l, sum+n+1, u+0.5+sum[l-1])-sum;
			if(r2==n+1) r2--;
			r1=r2-1;
			if(r1<=l) r1=l;
			//cout<<"r1="<<r1<<" s-s="<<sum[r1]-sum[l-1]<<" r2="<<r2<<" s-s="<<sum[r2]-sum[l-1]<<endl;
			if(u+0.5+sum[l-1]-sum[r1]<=sum[r2]-sum[l-1]-u-0.5) cout<<r1<<" ";			
			else cout<<r2<<" ";
		}
		cout<<endl;
	}
